...
public class Server {
    public static void main(String[] args) {
        try {
            ...
            ProductImpl p2 = new ProductImpl("Mobile", "MI 9 mobile",
                    24000.0);
            ProductImpl p3 = new ProductImpl("Bag", "Branded bag",
                    800.0);
            ProductImpl p4 = new ProductImpl("Charger", "MI Charger",
                    230.0);
            ...
            registry.rebind("ram", stub2);
            registry.rebind("bag", stub3);
            registry.rebind("charger", stub4);
        } catch (Exception e) {
